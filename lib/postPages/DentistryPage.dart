      ...
      builder: (context, postList, child) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Card(
              child: ListTile(
                title: Text(postList.allDentistryList[index].title, overflow: TextOverflow.ellipsis,),  // 게시물 제목
                subtitle: Text(postList.allDentistryList[index].question, overflow: TextOverflow.ellipsis,),  // 게시물 내용
