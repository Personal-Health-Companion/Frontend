...
class NeurologyPage extends StatefulWidget {
  const NeurologyPage({Key? key}) : super(key: key);

  @override
  State<NeurologyPage> createState() => _NeurologyPageState();
}

class _NeurologyPageState extends State<NeurologyPage> {
  @override
...
class NeurologyPanel extends StatefulWidget {
  const NeurologyPanel({Key? key}) : super(key: key);

  @override
  State<NeurologyPanel> createState() => _NeurologyPanelState();
}
...
class _NeurologyPanelState extends State<NeurologyPanel> {
  ...
  void update() {
    context.read<PostList>().updateNeurologyPostList();
  }
            ...
            ElevatedButton(
              onPressed: () async {
                if(TitleController.text != "" && QuestionController.text != "") {
                  Post savePost = Post(category: 'Neurology', title: TitleController.text, question: QuestionController.text, docName: null, answer: null);
