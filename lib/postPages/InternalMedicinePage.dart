      ...
      builder: (context, postList, child) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Card(
              child: ListTile(
                title: Text(postList.allInternalMedicineList[index].title, overflow: TextOverflow.ellipsis,),  // 게시물 제목
                subtitle: Text(postList.allInternalMedicineList[index].question, overflow: TextOverflow.ellipsis,),  // 게시물 내용
