              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      context.read<PostList>().searchOrthopedicPostList(Search.text);
                    },
                    child: Text("검색"),
                  ),
                ),
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: Card(
                        child: ListTile(
                          title: Text(postList.allOrthopedicList[index].title, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis,),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(postList.allOrthopedicList[index].question, style: TextStyle(fontSize: 18), maxLines: 2, overflow: TextOverflow.ellipsis,),
                              Row(
                                children: [
                                  Text(postList.allOrthopedicList[index].category, style: TextStyle(color: Colors.grey),),
                                  Text(" | "),
                                  Text(
                                    postList.allOrthopedicList[index].answer == null ? "답변 전" : "답변 완료",
