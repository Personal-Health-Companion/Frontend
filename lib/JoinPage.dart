              ...
              onChanged: (value) {
                setState(() {
                  ...
                  if (selectedCategory == '강원') {
                    itemsForSecondDropdown = ['강릉시', '원주시', '춘천시', '삼척시', '속초시', '영원군', '원주시', '동해시', '태백시', '동해시'];
                  } else if (selectedCategory == '경기') {
                    itemsForSecondDropdown = ['안산단원구', '성남분당구', '부천시', '수원영통구', '안양동안구', '용인처인구', '수원팔달구', '의정부시', '용인기흥구', '수원장안구', '안성시', '이천시', '파주시', '포천시', '광명시', '고양일산동구', '안산상록구', '남양주시', '성남수정구', '성남중원구', '오산시', '군포시', '평택시', '시흥시', '수원권선구', '화성시'];
                  } else if(selectedCategory == '경남') {
                    itemsForSecondDropdown = ['진주시', '양산시', '창원마산회원구', '김해시', '창원마산합포구', '창원성산구', '통영시', '창원진해구', '거제시'];
                  } else if(selectedCategory == '경북') {
                    itemsForSecondDropdown = ['김천시', '안동시', '포항북구', '구미시', '경주시', '상주시', '포항남구', '영천시', '영주시', '경산시'];
                  } else if(selectedCategory == '광주') {
                    itemsForSecondDropdown = ['광주동구', '광주광산구', '광주남구', '광주북구', '광주서구'];
                  } else if(selectedCategory == '대구') {
                    itemsForSecondDropdown = ['대구중구', '대구달서구', '대구남구', '대구북구', '대구수성구', '대구동구', '대구서구'];
                  } else if(selectedCategory == '대전') {
                    itemsForSecondDropdown = ['대전중구', '대전대덕구', '대전동구', '대전서구'];
                  } else if(selectedCategory == '부산') {
                    itemsForSecondDropdown = ['부산서구', '부산진구', '부산북구', '부산동래구', '부산기장군', '부산연제구', '부산남구', '부산수영구', '부산영도구', '부산해운대구'];
                  } else if(selectedCategory == '서울') {
                    itemsForSecondDropdown = ['종로구', '광진구', '동대문구', '구로구', '강남구', '서대문구', '양천구', '송파구', '동작구', '성북구', '서초구', '성동구', '영등포구', '은평구', '강동구', '중구', '노원구', '중랑구', '강서구', '용산구'];
                    ...
                    itemsForSecondDropdown = ['인천부평구', '인천남동구', '인천중구', '인천연수구', '인천서구', '인천강화군', '인천동구', '인천미추홀구'];
                  } else if(selectedCategory == '전남') {
                    itemsForSecondDropdown = ['화순군', '광양시', '순천시', '나주시', '목포시', '여수시', '영광군', '장흥군'];
                  } else if(selectedCategory == '전북') {
                    itemsForSecondDropdown = ['익산시', '전주덕진구', '부안군', '군산시', '전주완산구'];
                  } else if(selectedCategory == '제주') {
                    itemsForSecondDropdown = ['제주시'];
                  } else if(selectedCategory == '충남') {
                    itemsForSecondDropdown = ['천안동남구', '당진시', '서산시', '아산시', '논산시', '천안서북구', '예산군'];
                  } else if(selectedCategory == '충북') {
                    itemsForSecondDropdown = ['청주서원군', '충주시', '진천군', '청주상당구', '제천시'];
                  }
